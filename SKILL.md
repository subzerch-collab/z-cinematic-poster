...
- Apply a clearly visible high-end beauty-campaign finish by default, not a barely perceptible cleanup. Make the face bright, translucent, smooth, hydrated, and softly rosy, with an even luminous complexion and controlled dewy highlights on the forehead, cheeks, nose, and lips. Remove facial dullness, dark fine lines, uneven pigmentation, spots, freckles, acne marks, blemish marks, visible surface scars, redness, excess shine, under-eye darkness, and rough or dry texture. Add refined base makeup, groomed brows, defined eyes and lashes, healthy blush, subtle contour and highlight, finished lips, polished hair, and overall grooming. Retain fine controlled skin microtexture so the result reads as premium photography rather than wax. Preserve facial geometry, eye/nose/lip shape, apparent age, ethnicity, hairline, and the person's overall identity; surface marks are editable and should be cleaned unless the user asks to keep them. Beauty must come from skin finish, makeup, grooming, expression, and light—not from changing who the person is.
...
For the visual treatment and ratio-specific composition, read [references/black-gold-campaign.md](references/black-gold-campaign.md). Build a concise generation prompt from the user's scene plus the confirmed ratio and defaults above. Before returning, compare the generated face with the reference and check: unmistakably the same person; exact requested aspect ratio; full uncropped head; natural anatomy; evenly readable facial illumination without crushed shadows; visibly brighter milky-translucent skin with a soft rosy undertone, smooth hydration, and controlled luminosity; removal of dark lines and facial marks; intentional polished makeup and grooming; unified subject/background lighting; a visible soft double-exposure effect; and crisp high-detail foreground and mid-ground materials. For a 1:1 avatar, also preview the composition as a circular crop and confirm the face, hair, chin, and key gold details remain intact. If identity has drifted, the face is still dark or dull, dark lines or marks remain visible, or retouching looks plastic, do not accept the image: regenerate with a clean neutral-warm beauty key, stronger rosy fill, stronger surface cleanup, controlled skin sheen, simpler facial effects, and stronger identity language. A single side-view or severely obscured face may require inference for unseen features; keep the closest reliable scene-compatible angle or ask for an additional view instead of claiming an uncertain match.
