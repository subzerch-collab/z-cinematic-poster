...
For the visual treatment and ratio-specific composition, read [references/black-gold-campaign.md](references/black-gold-campaign.md). Build a concise generation prompt from the user's scene plus the confirmed ratio and defaults above. Before returning, compare the generated face with the reference and inspect the entire face at close range, including forehead, temples, both cheeks, the strip from the lower lash line through the upper cheek, nose, perioral area, and chin. Check: unmistakably the same person; the requested emotion is immediately readable, or the default expression looks naturally happy, lively, and approachable rather than tired or blank; exact requested aspect ratio; full uncropped head; natural anatomy; crisp eyes and facial landmarks without sharpened skin texture; evenly readable facial illumination; bright milky-translucent skin with a soft rosy undertone, smooth hydration, and continuous poreless-looking gradients; absolutely no isolated red, brown, or gray blemish dot, acne residue, dark spot, freckle, pigmentation patch, visible grain, enlarged pore, orange-peel texture, tear trough, eye bag, orange-brown under-eye rim, dark crease, tear track, or surface scar; makeup obvious at first glance; unified subject/background lighting; and optical effects outside the central face. A single visible blemish residue fails the check. If the expression, under-eye, or skin check fails, keep the accepted poster composition and perform a localized identity-preserving face edit rather than regenerating the whole scene: adjust only the facial-muscle expression as needed; reconstruct each blemished patch from the clean surrounding complexion so every isolated mark disappears; even the skin tone and under-eye zone; preserve facial form, natural light modeling, and the eye/nose/lip shapes; and keep the eyes and facial landmarks crisp. Do not use global blur to hide marks. Allow at most two hidden localized repair attempts; if the result still fails, do not display it as successful. Follow the final-only display protocol: surface only the newest accepted result after all repairs, using one display action. A single side-view or severely obscured face may require inference for unseen features; keep the closest reliable scene-compatible angle or ask for an additional view instead of claiming an uncertain match.
