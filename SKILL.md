...
- Apply a clearly visible high-end beauty-campaign finish by default, not a barely perceptible cleanup. Make the face bright, milky-translucent, silky-smooth, hydrated, and softly rosy, with continuous tonal gradients and controlled dewy highlights on the forehead, upper cheeks, nose, cupid's bow, and lips. Fully remove tear tracks, dark fine lines, under-eye creases and darkness, uneven pigmentation, spots, freckles, acne marks, blemish marks, visible surface scars, redness, roughness, dry texture, mottled shadow, enlarged pores, orange-peel texture, camera grain, and sharpening grit. At normal viewing size and in a close face crop, cheeks, under-eyes, nose skin, and forehead must read as polished smooth skin with no individually recognizable pores or granular texture; retain realism through facial form, subsurface color variation, and controlled light rather than visible pore detail. Add makeup that is immediately visible at first glance: refined base, shaped brows, clean eyeliner or eye definition, separated lashes, healthy blush, subtle contour and highlight, softly colored glossy lips, polished hair, and overall grooming. Preserve facial geometry, eye/nose/lip shape, apparent age, ethnicity, hairline, and the person's overall identity; surface marks are editable and should be cleaned unless the user asks to keep them. Beauty must come from skin finish, makeup, grooming, expression, and light—not from changing who the person is.
...
For the visual treatment and ratio-specific composition, read [references/black-gold-campaign.md](references/black-gold-campaign.md). Build a concise generation prompt from the user's scene plus the confirmed ratio and defaults above. Before returning, compare the generated face with the reference and inspect the face at close range, especially the strip from the lower lash line through the tear trough to the upper cheek. Check: unmistakably the same person; the requested emotion is immediately readable, or the default expression looks naturally happy, lively, and approachable rather than tired or blank; exact requested aspect ratio; full uncropped head; natural anatomy; crisp eyes and facial landmarks without sharpened skin texture; evenly readable facial illumination; bright milky-translucent skin with a soft rosy undertone, smooth hydration, and continuous poreless-looking gradients; no visible grain, enlarged pores, orange-peel texture, tear trough, eye bag, orange-brown under-eye rim, dark crease, tear track, spot, acne mark, or blemish mark; makeup obvious at first glance; unified subject/background lighting; and optical effects outside the central face. If the expression, under-eye, or skin check fails, keep the accepted poster composition and perform a localized identity-preserving face edit rather than regenerating the whole scene: adjust only the facial-muscle expression as needed, brighten and color-correct the under-eye zone, blend it smoothly into the cheek, clean surface defects and visible skin grain, preserve facial geometry and the eye/nose/lip shapes, and keep the eyes and facial landmarks crisp. Allow at most two hidden localized repair attempts. Follow the final-only display protocol: surface only the newest accepted result after all repairs, using one display action. A single side-view or severely obscured face may require inference for unseen features; keep the closest reliable scene-compatible angle or ask for an additional view instead of claiming an uncertain match.
