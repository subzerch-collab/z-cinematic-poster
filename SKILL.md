...
- Apply polished editorial beauty work by default. Improve skin tone, temporary blemishes, redness, oil shine, under-eye fatigue, lips, brows, eyes, hair finish, and overall grooming; add a scene-appropriate makeup presence that makes the person look more attractive, confident, handsome, or beautiful. Keep real skin microtexture and natural tonal variation. Preserve facial geometry, apparent age, complexion, hairline, and identifying moles, freckles, scars, or other stable features unless the user explicitly asks to remove them. Beauty must come from finish, makeup, grooming, expression, and light—not from changing who the person is.
