...
- Keep the primary face optically sharp at the highest supported native resolution. The irises, catchlights, eyelashes, brows, nostril edges, lip line, and hair strands must have clean focus and precise edges while the skin tone remains smooth. Never apply soft focus, motion blur, diffusion, bloom, haze, double exposure, denoise smearing, or glow across the central face; restrict those effects to the background, hair perimeter, outer silhouette, and secondary afterimage.
...
For the visual treatment and ratio-specific composition, read [references/black-gold-campaign.md](references/black-gold-campaign.md). Build a concise generation prompt from the user's scene plus the confirmed ratio and defaults above. Before returning, compare the generated face with the reference and check: unmistakably the same person; exact requested aspect ratio; full uncropped head; natural anatomy; tack-sharp central face and eyes; evenly readable facial illumination without crushed shadows; visibly brighter milky-translucent skin with a soft rosy undertone, smooth hydration, and controlled luminosity; complete removal of tear tracks, dark lines, under-eye darkness, spots, acne marks, and blemish marks; makeup that is obvious at first glance; unified subject/background lighting; a visible soft double-exposure effect outside the central face; and crisp high-detail foreground and mid-ground materials. For a 1:1 avatar, also preview the composition as a circular crop and confirm the face, hair, chin, and key gold details remain intact. If identity has drifted, the face is soft or blurry, any listed mark remains visible, makeup is not apparent, or retouching looks waxy, do not accept the image: regenerate with face sharpness prioritized over atmosphere, stronger localized surface cleanup, clearer eye/brow/lash/lip makeup, a clean neutral-warm beauty key, and all optical effects excluded from the central face. Return only the single best final result. A single side-view or severely obscured face may require inference for unseen features; keep the closest reliable scene-compatible angle or ask for an additional view instead of claiming an uncertain match.
